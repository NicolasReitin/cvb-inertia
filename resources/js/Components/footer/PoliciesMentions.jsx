  ...
  return (
    <>
        ...
        <div className='lg:mt-16 lg:flex lg:justify-center lg:gap-48'>
            ...
            <div className='social-networks flex justify-center gap-8 mb-4 lg:mb-0'>
                <a target='_blank' rel="stylesheet" href="https://instagram.com/caenvolleyball/">
                    <img className='' src="/assets/icones/instagram.png" alt="instagram Caen Volley Ball" />
                </a>
                <a target='_blank' rel="stylesheet" href="https://facebook.com/cvbofficiel/">
                    <img className='' src="/assets/icones/facebook.png" alt="facebook Caen Volley Ball" />
                </a>        
            </div>
            <div className="sign flex flex-col lg:flex-row items-center justify-center gap-2 lg:gap-8">
                <p className='text-white'>2025 © Tous droits réservés. Caen Volley Ball</p>
